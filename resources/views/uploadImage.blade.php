  ...
  <body>
    <div class="bg-dark">
      <div class="container py-3">
        <div class="h1 text-white">Upload Image onto Server</div>
      </div>
    </div>
    <div class="container mt-5 d-flex justify-content-between align-items-center">
      <div class="h2">Choose Image to upload on Server</div>
    ...
    <div class="container mt-5 row">
      <div class="card col col-md-6 mx-auto mt-5">
        <div class="card-body">
          ...
          <button class="btn btn-primary mt-4 w-100">Upload Image</button>
